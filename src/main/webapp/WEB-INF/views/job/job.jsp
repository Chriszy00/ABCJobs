...
<%-- 		<!-- Search form -->
		<form method="GET" action="/job" class="mb-3">
						...
						<form:form action="apply/${j.getJobId()}" method="post">
							<div class="mb-3 px-2">
								<label for="resume" class="form-label">Resume</label> <input
									type="text" class="form-control" id="resume" name="resume"
									required placeholder="Provide a link to your resume">
							</div>
						...
						<div class="card-body p-5">
							<div class="image-and-company-container">
								...
								<div class="company-info">
									...
									<p class="card-title text-wrap fs-6">${j.jobDesc}</p>
